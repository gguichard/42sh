...
/*   Updated: 2019/04/09 16:05:20 by tcollard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// const char		*get_home_value(const char *s)
// {
// 	char	*dir;
// 	char	*tmp;
//
...
// 	if (s[0] == '~' && (s[1] == '/' || s[1] == '\0' || s[1] == ':'
// 			|| s[1] == '='))
// 		return (get_home_directory(vars), &(s[1]));
// 	else if (ft_strnequ(s, "~-", 2) && (s[2] == '/' || s[2] == '\0'
// 				|| s[2] == ':' || s[2] == '='))
// 		return (get_var_value(vars, "OLDPWD"), &(s[2]));
// 	else if (ft_strnequ("~+", s, 2) && (s[2] == '/' || s[2] == '\0'
// 				|| s[2] == ':' || s[2] == '='))
// 		return (get_var_value(vars, "PWD"), s[2]);
// 	else if (s[0] == '~' && (ft_isalpha(s[1]) || s[1] == '_'))
// 		return (get_path_tilde(&(s[1])));
// 	return (NULL);
//
// }
//
...
// 	{
// 		if ((*s)[*pos] == '=' && (*s)[*pos + 1] == '~')
// 			ft_strreplace_inside(s, *pos + 1, 1, get_home_value(*s, *pos + 1, vars));
