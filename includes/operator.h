...
void					redirection(t_ast *elem, t_var **lst_env,
						t_alloc *alloc);
...
void					redirection_1(t_ast *elem, t_var **lst_env,
						t_alloc *alloc);
void					redirection_2(t_ast *elem, t_var **lst_env,
						t_alloc *alloc);
void					redirection_3(t_ast *elem, t_var **lst_env,
						t_alloc *alloc);
